...
import com.example.gamegal_app.Model.Comment
            ...
            override fun onDataChange(p0: DataSnapshot) {
                if(p0.exists()){
                    ...
                    if (user!!.getImage().isEmpty()) {
                        Picasso.get().load(R.drawable.profile).into(imageProfile) //if publisher hasnt profile photo it will load from drawable
                    }
                    else {
