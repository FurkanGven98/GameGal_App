...
import com.example.gamegal_app.Adapter.ChatRecyclerAdapter
import com.example.gamegal_app.Model.Chat
import com.example.gamegal_app.R
import com.example.gamegal_app.databinding.FragmentChatBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        firestore.collection("Chats").orderBy("date",
            ...
            if(error!=null){
                ...
                if(value != null){
                    if(value.isEmpty){
                        Toast.makeText(requireContext(),"Mesaj bulunamadı.", Toast.LENGTH_LONG).show()
                    }else{
